...
use PoolTournament\App\Module\Core\Entrypoint\Http\Rest\Routing\RouteCollection;
...
class RouterTest extends TestCase
{
    ...
    public function testCreateFromConfigWhenConfigIsCorrect()
    {
        $config = [
            'base_path' => '/root/',
            'routes' => [
                'routeTest' => ['/test/', 'UnitTest\Module\Core\Entrypoint\Http\Rest\Routing\Fixtures\TestController::testAction', ['GET']]
            ]
        ];
